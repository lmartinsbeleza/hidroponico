...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css?v=MtWub4"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css?v=MtWub4" type="text/css">
    ...
    <nav class="navbar navbar-dropdown navbar-expand-lg">
        <div class="container-fluid">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-primary display-5" href="https://mobiri.se">HidroView<br></a></span>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-primary display-7" href="index.html#content4-5">Diferencial</a></li>
                    <li class="nav-item"><a class="nav-link link text-primary display-7" href="index.html#content4-6">Atualmente</a>
                    </li><li class="nav-item"><a class="nav-link link text-primary display-7" href="index.html#features16-9">Sobre</a></li><li class="nav-item"><a class="nav-link link text-primary display-7" href="index.html#features16-9">Time</a></li><li class="nav-item"><a class="nav-link link text-primary display-7" href="index.html#features16-9">Galeria</a></li></ul>
                
                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-primary display-4" href="https://mobiri.se">Dashboard</a></div>
            </div>
        </div>
    </nav>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>HidroView</strong><strong><br></strong></h1>
                
                <p class="mbr-text mbr-fonts-style display-7">Monitoramento inteligente da água para sua produção agrícola, com um controle preciso dos parâmetros hídricos para otimizar suas culturas hidropônicas e agrícolas.<br></p>
        ...
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2">
                    <strong>Nosso Diferencial</strong></h3>
...
<section data-bs-version="5.1" class="features1 cid-uO2j6jE8WS" id="features2-1">
            ...
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7"><strong>Multi-disponibilidade</strong></h4>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <strong>Detalhamento Visual</strong></h4>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <strong>Portabilidade</strong></h4>
                    </div>
                </div>
            </div>
        </div>
...
<section data-bs-version="5.1" class="content4 cid-sFADQQfNeA" id="content4-6">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-1"><strong>Atualmente</strong></h3>
                <h4 class="mbr-section-subtitle align-center mbr-fonts-style mb-4 display-5">Para um inicio, está sendo utilizado primeiramente...</h4>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="assets/images/r-816x612.jpg" alt="Mobirise Website Builder">
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="assets/images/plantas-hidroponicas-816x544.jpg" alt="Mobirise Website Builder">
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
        ...
        <div class="card">
            <div class="card-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="assets/images/2017-11-03-23-28-54-816x537.jpg" alt="Mobirise Website Builder">
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
        ...
        <div class="content-wrapper">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img src="assets/images/10947344-b64ec61005-500x375.jpg" alt="Mobirise Website Builder">
                    </div>
                </div>
            </div>
        </div>
...
<section data-bs-version="5.1" class="team1 cid-uO2eCWVsHW" id="team1-0">
                ...
                <div class="item-wrapper">
                    ...
                    <div class="content-wrap">
                        ...
                        <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4">
                            <strong>Programador</strong><strong><br></strong></h6>
                        <p class="card-text mbr-fonts-style align-center display-7">
                            Desenvolvimento e Comunicação entre Sistema e Supervisório</p>
            ...
            <div class="item features-image mb-4 col-12 col-md-4">
                <div class="item-wrapper">
                    ...
                    <div class="content-wrap">
                        ...
                        <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4">
                            <strong>Eletrônico</strong><strong><br></strong></h6>
                        <p class="card-text mbr-fonts-style align-center display-7">
                            Descrição sobre o trabalho...</p>
            ...
            <div class="item features-image mb-4 col-12 col-md-4">
                <div class="item-wrapper">
                    ...
                    <div class="content-wrap">
                        ...
                        <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>Mecânico</strong></h6>
                        <p class="card-text mbr-fonts-style align-center display-7">
                            Descrição sobre o trabalho...</p>
...
<section data-bs-version="5.1" class="gallery6 mbr-gallery cid-sFAQAQGsOD" id="gallery6-f">
    ...
    <div class="container-fluid">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center m-0 display-2"><strong>Galeria de Imagens</strong></h3>
        ...
        <div class="row mbr-gallery mt-4">
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#uO2pdllbzB-modal" data-bs-target="#uO2pdllbzB-modal">
                    <img class="w-100" src="assets/images/mbr.jpg" alt="Mobirise Website Builder" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-uO2pdllbzB" data-bs-target="#lb-uO2pdllbzB">
            ...
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#uO2pdllbzB-modal" data-bs-target="#uO2pdllbzB-modal">
                    <img class="w-100" src="assets/images/mbr-5.jpg" alt="Mobirise Website Builder" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-uO2pdllbzB" data-bs-target="#lb-uO2pdllbzB">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#uO2pdllbzB-modal" data-bs-target="#uO2pdllbzB-modal">
                    <img class="w-100" src="assets/images/mbr-1.jpeg" alt="Mobirise Website Builder" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-uO2pdllbzB" data-bs-target="#lb-uO2pdllbzB">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#uO2pdllbzB-modal" data-bs-target="#uO2pdllbzB-modal">
                    <img class="w-100" src="assets/images/mbr-10.jpeg" alt="Mobirise Website Builder" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-uO2pdllbzB" data-bs-target="#lb-uO2pdllbzB">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="media-container-row align-center mbr-white">
            <div class="row row-links">
                ...
                <li class="foot-menu-item mbr-fonts-style display-7"><a href="#top" class="text-white">Home</a></li><li class="foot-menu-item mbr-fonts-style display-7">Diferencial</li><li class="foot-menu-item mbr-fonts-style display-7">Atualmente</li><li class="foot-menu-item mbr-fonts-style display-7">Sobre</li><li class="foot-menu-item mbr-fonts-style display-7">Time<br></li><li class="foot-menu-item mbr-fonts-style display-7">Galeria</li></ul>
            </div>
...
</section><section class="display-7" style="padding: 0;align-items: center;justify-content: center;flex-wrap: wrap;    align-content: center;display: flex;position: relative;height: 4rem;"><a href="https://mobiri.se/2525514" style="flex: 1 1;height: 4rem;position: absolute;width: 100%;z-index: 1;"><img alt="" style="height: 4rem;" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="></a><p style="margin: 0;text-align: center;" class="display-7">&#8204;</p><a style="z-index:1" href="https://mobirise.com/offline-website-builder.html">Offline Website Builder</a></section><script src="assets/bootstrap/js/bootstrap.bundle.min.js"></script>  <script src="assets/parallax/jarallax.js"></script>  <script src="assets/smoothscroll/smooth-scroll.js"></script>  <script src="assets/ytplayer/index.js"></script>  <script src="assets/dropdown/js/navbar-dropdown.js"></script>  <script src="assets/theme/js/script.js"></script>  
